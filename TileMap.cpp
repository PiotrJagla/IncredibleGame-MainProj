...
void TileMap::makeMap(int tileMapNumber)
{
	...
	else if (tileMapNumber == 2)
	{
		m_mapVisualization.push_back( L"&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
		m_mapVisualization.push_back( L"&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
		m_mapVisualization.push_back( L"&&.................................................................................................X&X....................&&");
		m_mapVisualization.push_back( L"&&....................&&&&&&&&&&&.....&&&&&&&&&&&&&&&&&&&&&......&.&.......................&&&&&&&&&&&&&.....&............&&");
		m_mapVisualization.push_back( L"&&.&&&&&&&&......................................................&.&......&&&&........&.............&................&&X..&&");
		m_mapVisualization.push_back( L"&&.&......&&...............................X.....................&.&X...............................&.................&&&.&&");
		m_mapVisualization.push_back( L"&&.....&XX&&&........................&&&&&&&&....................&.&&&..............................&...................&.&&");
		m_mapVisualization.push_back( L"&&&&&&.&&&&&&&&&&................................................&..................................&.....................&&");
		m_mapVisualization.push_back( L"&&..X&.....&....&&&..............................................&&&&&&&............................&.........&&&&&&&&&..&&&");
		m_mapVisualization.push_back( L"&&..&&&&&..&.......................................................................................&&.....................&&");
		m_mapVisualization.push_back( L"&&.........&...............&&&&&&...................................................................&.....................&&");
		...
		m_mapVisualization.push_back( L"&&..........&&..&......&.............&...................................&&&............................&&&&.....&....&...&&");
		m_mapVisualization.push_back( L"&&&&&.......&..........&&&...........&..................................&&&.X&..........................&&................&&");
		m_mapVisualization.push_back( L"&&X.........&..........&&&.............................................&&&.X&&.........................&&&X...............&&");
		m_mapVisualization.push_back( L"&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"); 
		m_mapVisualization.push_back( L"&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"); 
		//Bombs possible positions: (x,y)
		//(2,36) (13,33) (13,30) (36,28) (4,8) (8,6) (9,6) (42,5) (68,5) (99,2) (99,8) (101,2) (119,4) (30,11) (
...
void TileMap::initTileMap()
{
	...
	for (int iii{ 0 }; iii < m_mapVisualization.size(); ++iii)
	{
		...
		for (int kkk{ 0 }; kkk < m_mapVisualization[0].size(); ++kkk)
		{
			...
			if (m_mapVisualization[iii].at(kkk) == '.' || m_mapVisualization[iii].at(kkk) == 'X')
			{
